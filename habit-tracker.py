...
def collect_user_information():
    st.write("Welcome to the habit tracker! Do you have an account")
    if st.button("Yes", "button1"):
        st.write("Now we will validate your identity.")
...
def main_loop():
    ...
    # print the hand drawn logo at the top
    collect_user_information()
